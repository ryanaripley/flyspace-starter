<?php
/**
 * Flyspace functions and definitions
 *
...
if ( ! function_exists( 'flyspace_setup' ) ) :
	/**
	 ...
	 */
	function flyspace_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Flyspace, use a find and replace
		 * to change 'flyspace' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'flyspace', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'flyspace_custom_background_args', array(
...
add_action( 'after_setup_theme', 'flyspace_setup' );
 ...
 */
function flyspace_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'flyspace_content_width', 640 );
}
add_action( 'after_setup_theme', 'flyspace_content_width', 0 );
 ...
 */
function flyspace_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'flyspace' ),
		'id'            => 'sidebar-1',
...
function flyspace_scripts() {
	...
	wp_enqueue_style( 'flyspace-style', get_stylesheet_uri(), array(), '20190410b' );

	wp_enqueue_script( 'flyspace-global', get_template_directory_uri() . '/js/global.js', array(), '20190221', true );

	wp_enqueue_script( 'flyspace-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20190221', true );

	wp_enqueue_script( 'flyspace-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20190221', true );
 ...
 * Icon set
 */
require get_template_directory() . '/inc/icon-set.php';
